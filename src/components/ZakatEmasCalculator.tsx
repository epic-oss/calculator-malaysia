  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-emerald-50 to-white py-8">
      ...
      <div className="hidden md:flex fixed bottom-5 right-6 z-50 flex-col items-end gap-2">
        ...
        {showFloatingCTA && (
          <>
            <div className="bg-white px-3 py-1.5 rounded-full shadow-md text-xs text-slate-500">5,000+ pengiraan · Kadar nisab terkini</div>
            <button onClick={scrollToTop} className="px-5 py-2.5 text-white font-bold rounded-full shadow-lg transition-all hover:opacity-90 text-sm" style={{ backgroundColor: "#00796B" }}>
              Kira Zakat →
            </button>
          </>
        )}
