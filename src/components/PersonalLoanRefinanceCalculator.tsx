    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      ...
      <div className="relative overflow-hidden bg-gradient-to-r from-blue-600 to-indigo-700 text-white py-10 md:py-14">
        ...
        <div className="relative max-w-4xl mx-auto px-4 text-center">
          <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-sm rounded-full px-4 py-1.5 text-sm font-medium mb-4">💰 Refinance Calculator</div>
          <div className="text-5xl md:text-6xl mb-4">🔄</div>
          <h1 className="text-3xl md:text-4xl font-extrabold mb-3">Personal Loan Refinance Calculator Malaysia {currentYear}</h1>
          <p className="text-white/80 text-base md:text-lg max-w-2xl mx-auto">Calculate how much you can save by consolidating high-interest debts into one lower-rate loan</p>
        </div>
