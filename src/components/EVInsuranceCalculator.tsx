...
export default function EVInsuranceCalculator() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      {/* Hero Header */}
      <div className="relative overflow-hidden bg-gradient-to-r from-green-600 to-teal-700 text-white py-10 md:py-14">
        ...
        <div className="relative max-w-4xl mx-auto px-4 text-center">
          <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-sm rounded-full px-4 py-1.5 text-sm font-medium mb-4">🛡️ EV Insurance Calculator</div>
          <div className="text-5xl md:text-6xl mb-4">⚡</div>
          <h1 className="text-3xl md:text-4xl font-extrabold mb-3">EV Car Insurance Calculator Malaysia {currentYear}</h1>
          <p className="text-white/80 text-base md:text-lg max-w-2xl mx-auto">Calculate your electric vehicle insurance premium in Malaysia</p>
        </div>
      ...
      <div className="hidden md:flex fixed bottom-5 right-6 z-50 flex-col items-end gap-2">
        ...
        {showFloatingCTA && (
          <>
            <div className="bg-white px-3 py-1.5 rounded-full shadow-md text-xs text-slate-500">2,400+ policies compared · Save avg RM340/yr</div>
