...
export default function PersonalLoanCalculator({ locale = "en" }: PersonalLoanCalculatorProps) {
  ...
  const handleFormSubmit = async (e: React.FormEvent) => {
    ...
    const leadData = {
      ...
      tenure: capturedCalc.tenureYears,
      monthly_payment: capturedCalc.monthlyPayment,
      dsr_percentage: capturedCalc.dsrPercent,
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      ...
      <div className="relative overflow-hidden bg-gradient-to-r from-blue-600 to-indigo-700 text-white py-10 md:py-14">
        ...
        <div className="relative max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-white/80 text-base md:text-lg max-w-2xl mx-auto">{t.subtitle}</p>
        </div>
      ...
      <div className="hidden md:flex fixed bottom-6 right-6 z-50 flex-col items-end gap-3">
        ...
        {showFloatingCTA && (
          <>
            ...
            <button onClick={() => openModal("results_card")} className="px-6 py-3 bg-green-700 hover:bg-green-800 text-white font-bold rounded-full shadow-lg transition-all">
              Check Eligibility →
            </button>
          </>
        )}
