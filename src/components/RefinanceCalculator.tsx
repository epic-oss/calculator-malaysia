...
const PROPERTY_TYPES = [
  ...
  { label: "Condominium / Apartment", value: "condo" },
  { label: "Semi-Detached", value: "semi-d" },
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <nav className="text-sm mb-6">
          <ol className="flex items-center gap-2 text-slate-500">
            ...
            <li>/</li>
            <li><a href="/property" className="hover:text-slate-700">Property</a></li>
            <li>/</li>
            <li className="text-slate-700">Refinance Calculator</li>
          </ol>
        </nav>

        <h1 className="text-3xl font-bold text-center text-slate-800 mb-2">
          Refinance Housing Loan Calculator Malaysia {currentYear}
        </h1>
            ...
            <div className="lg:sticky lg:top-8 space-y-6">
              ...
              <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl p-6 border border-blue-200">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <h3 className="text-lg font-bold text-slate-800">Get the Best Refinance Rates</h3>
                </div>
                <p className="text-sm text-slate-600 mb-4">
                  Compare offers from 15+ banks in 5 minutes. Free consultation, no obligation.
                </p>
                <button
          ...
          <div className="bg-white rounded-2xl shadow-xl max-w-md w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6 border-b border-slate-100">
              <div className="flex justify-between items-center">
                <h3 className="text-xl font-bold text-slate-800">Get Your Free Refinance Quote</h3>
                <button
                  onClick={() => {
                    setShowModal(false);
              ...
              {submitSuccess ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-slate-600">
                    Our loan specialist will contact you within 24 hours to discuss the best refinance options for you.
                  </p>
                </div>
              ) : (
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-slate-700 mb-1">Current Bank (Optional)</label>
                    <select
