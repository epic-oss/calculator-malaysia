    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      ...
      <div className="relative overflow-hidden bg-gradient-to-r from-slate-700 to-slate-800 text-white py-10 md:py-14">
        ...
        <div className="relative max-w-4xl mx-auto px-4 text-center">
          <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-sm rounded-full px-4 py-1.5 text-sm font-medium mb-4">🚙 Kalkulator Auto</div>
          <div className="text-5xl md:text-6xl mb-4">🚗</div>
          <h1 className="text-3xl md:text-4xl font-extrabold mb-3">Kalkulator Refinance Kereta Malaysia {currentYear}</h1>
          <p className="text-white/80 text-base md:text-lg max-w-2xl mx-auto">Kira berapa anda boleh jimat dengan refinance pinjaman kereta anda</p>
        </div>
      ...
      <div className="hidden md:flex fixed bottom-6 right-6 z-50 flex-col items-end gap-3">
        ...
        {showFloatingCTA && (
          <>
            ...
            <button onClick={scrollToTop} className="px-6 py-3 bg-slate-700 hover:bg-slate-800 text-white font-bold rounded-full shadow-lg transition-all">
              Check Eligibility →
            </button>
          </>
        )}
